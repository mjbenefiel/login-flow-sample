...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Iterable-iOS-SDK/IterableSDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/mParticle-Iterable/mParticle_Iterable.framework"
